...
logInOpen(context, snapshot.data!.productId!, snapshot.data!.subcategory!.subcategoryId!, snapshot.data!.category!.categoryCategoryId!);
   ...
   await showDialog<bool>(
          ...
          builder: (context) {
          return AlertDialog(
          title:  Text(widget.url=="tm"?'Siz hakykatdanam pozmakçymy':"Ты действительно собираешься все испортить?"),
          actionsAlignment: MainAxisAlignment.spaceBetween,
          actions: [
          TextButton(
          onPressed: () {
                  ...
                  children: [
                    ...
                    widget.discount == true
                        ? TextFieldAddProduct().addText(
                            ...
                            false)
                        : Container(),
                    kategoriya(widget.url=="tm"?"Kategoriýa":"Категория",productModel.subcategory==null?"": productModel.category!.nameTm!),
                    kategoriya(
                        widget.url=="tm"? "Sub-Kategoriýa":"Подкатегория",productModel.subcategory==null?"": productModel.subcategory!.nameTm!),
                    TextFieldAddProduct().addText(
                        2,
                        maglummat[2][1],
                        false,
