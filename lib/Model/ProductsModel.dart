...
//
//     final productsMainPageModel = productsMainPageModelFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

ProductsMainPageModel productsMainPageModelFromJson(String str) => ProductsMainPageModel.fromJson(json.decode(str));

String productsMainPageModelToJson(ProductsMainPageModel data) => json.encode(data.toJson());

class ProductsMainPageModel {
  ProductsMainPageModel({
  ...
  factory ProductsMainPageModel.fromJson(Map<String, dynamic> json) => ProductsMainPageModel(
